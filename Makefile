...
CC_DEBUG_FLAGS = $(CC_COMMON_FLAGS) $(CC_SANITIZER_FLAGS) -g -O0
CC_OPT_FLAGS = $(CC_COMMON_FLAGS) $(CC_SANITIZER_FLAGS) -g -O0
CC_RELEASE_FLAG = $(CC_COMMON_FLAGS) $(CC_LTO_FLAG) -g -O0
